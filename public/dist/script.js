...
gridTable.onclick = function (e) {
   ...
   // a=selectedDate.toLocaleString("en-US");
...
//    let Start = document.getElementById("eventStartInput").value.trim();
//    let End = document.getElementById("eventEndInput").value.trim();
